...
{
    public function consultar($pesquisa, $nome, $documento,$telefone,$cep, $bairro, $rua, $numero, $ativo,$tipo_colaborador)
    {
        ...
        $ativo = $this->db->escape_str($ativo);
        $this->db->like('ativo', $ativo);       
